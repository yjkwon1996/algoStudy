# 스티커. 상근이의 여동생 상냥이는 문방구에서 스티커 2n개를 구매했다. 스티커는 그림 (a)와 같이 2행 n열로 배치되어 있다. 상냥이는 스티커를 이용해 책상을 꾸미려고 한다.
...
for _ in range(T) :
    ...
    up = list(map(int, input().rstrip().split()))
    down = list(map(int, input().rstrip().split()))
