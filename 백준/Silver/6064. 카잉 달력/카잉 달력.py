# 카잉 달력. 최근에 ICPC 탐사대는 남아메리카의 잉카 제국이 놀라운 문명을 지닌 카잉 제국을 토대로 하여 세워졌다는 사실을 발견했다. 카잉 제국의 백성들은 특이한 달력을 사용한 것으로 알려져 있다.
...
# +1      +1    +1  ...  +1  x가 10 초과, 1로. +1  y가 12 초과, 1로
# 10 12 3 9 (33) -> year = 10*a+3 = 12*b+9 -> (year-3)은 10으로 나누어 떨어지고. (year-9)는 12로 나누어 떨어짐
# 최소공배수. (33-x) % N == 0  && (33-y) % M == 0 인 경우.